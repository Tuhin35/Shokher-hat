...
const Footer = () => {
    return (
        <div className="py-10 dark:bg-gradient-to-r text-black sm:pt-16 lg:pt-24">
                ...
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        ...
                        <ul className="flex items-center space-x-3 mt-9 dark:text-snow-white-toned">
                            <li>
                                <Link href="" title="" className="flex items-center justify-center  transition-all duration-200  rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            ...
                            <li>
                                <Link href="https://www.facebook.com/ariaan.tuhin" title="" className="flex items-center justify-center  transition-all duration-200  rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                                    <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <li>
                                <Link href="https://www.instagram.com/raihan_tuhin/" title="" className="flex items-center justify-center  transition-all duration-200 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                                    <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <li>
                                <Link href="https://github.com/Tuhin35" title="" className="flex items-center justify-center  transition-all duration-200  rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                                    <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                        <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
