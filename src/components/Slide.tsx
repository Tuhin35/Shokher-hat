    ...
    <div className="outline-none border-none relative">
     <div
      ...
      >
        ...
        <h3 className="text-blackish text-[26px] md:text-[30px] lg:text-[44px] font-bold leading-[1.2]">
          {mainTitle}
        </h3>
        <h1 className="text-[24px] text-gray-500">
          starting at{" "}
          {/* <b className='bg-accent text-white text-[14px] md:text-[16px] p-2 px-4 
            '></b> */}
          <b className="text-[20px] md:test-24px lg:text-[30px]">{price}</b>.00
        </h1>
        <div
